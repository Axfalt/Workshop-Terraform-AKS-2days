...
data "terraform_remote_state" "Terra-datasource-acr" {
  ...
  config = {
    resource_group_name  = "RG-Labo-Yro"    # mettre ici le nom du resource group de vos ressource
    storage_account_name = "tfyohannlabmirosoft" # mettre le nom du compte de stockage créer dans le lab 1
